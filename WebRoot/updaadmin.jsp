		...
		<div id="row">
			...
			<div id="row">
				...
				<div class="col c8">
					...
					<center>
		<s:form action="upadmin"  method="post" namespace="/" onsubmit="return register1();">
			<p id="namets2"									
			style="width: 150px; height: 12px;  font-size: 12px;"></p>
			</br>
			<s:hidden name="admin.admindid" value="%{admin.admindid}"/>
			<s:textfield label="用户名" name="admin.name" id="uName1" placeholder="用户名" 
				cssClass="addin" value="%{admin.name}" onblur="return checkname1()" ></s:textfield>
			<s:password label="密码" name="admin.pwd" id="uPass1" placeholder="密码"
				cssClass="addin" value="%{admin.pwd}" onblur="return checkpass1();" ></s:password>
			<s:textfield label="年龄" name="admin.age" id="uAge" placeholder="年龄"
				cssClass="addin" value="%{admin.age}" onblur="return checkage()" ></s:textfield>
			<s:radio name="admin.sex" list="#{'男':'男','女':'女'}" value="%{admin.sex}" 
			cssStyle="margin-left:10px; margin-top:15px;margin-bottom:15px;"> </s:radio>
			<s:textfield label="联系方式" name="admin.tel" id="uTel" placeholder="联系方式"
				cssClass="addin" value="%{admin.tel}" onblur="return checktel()" ></s:textfield>
			<s:textfield label="邮箱" name="admin.email" id="uEmail" placeholder="邮箱"
				cssClass="addin" value="%{admin.email}" onblur="return checkemail()" ></s:textfield>

			...
			<div class="row">
				...
				<div class="col c8_table">
					...
					<div class="div_bottom">
						  当前第<b>
						 <font style="color:red;"><s:property value="#request.orderinfo.currentPage" /></font> /
						 <s:property value="#request.orderinfo.totalPage" /></b>页
						 <s:if test="#request.orderinfo.currentPage==#request.orderinfo.totalPage">
						 	 <a href="" class="a_bottom">尾页</a> 
							 <a href="" class="a_bottom">下一页</a> 
						 </s:if>
						 <s:else>
							 <a href="orderRecord.action?page=<s:property value="#request.orderinfo.totalPage"/>" class="a_bottom">尾页</a> 
						 	<a href="orderRecord.action?page=<s:property value="#request.orderinfo.currentPage + 1"/>" class="a_bottom">下一页</a> 
						 </s:else>
						 <s:if test="#request.orderinfo.currentPage==1">
						 	 <a href="" class="a_bottom">上一页</a> 
							 <a href="" class="a_bottom">首页</a>
						 </s:if>
						 <s:else>
						 <a href="orderRecord.action?page=<s:property value="#request.orderinfo.currentPage - 1"/>" class="a_bottom">上一页</a> 
						 <a href="orderRecord.action" class="a_bottom">首页</a>
						 </s:else>
					</div>
				</div>

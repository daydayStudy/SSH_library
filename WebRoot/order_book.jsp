		...
		<div id="row">
			...
			<div class="row">
					...
					<div class="div_title">
						...
						<div id="div_borrow_info2">
							<s:form name="orderrecordinfo" method="post" namespace="/" onsubmit="return checkOrderNumber();">
								...
								value="%{#request.readerid}"></s:textfield>
								<font class="font_style">预定日期:</font>
								<s:textfield theme="simple" name="borrowdate" cssClass="order" readonly="true" id="order_date"></s:textfield>
								<br/>
								<font class="font_style">类别名:</font>
								<s:textfield theme="simple" name="booktype" cssClass="order" readonly="true"
								value="%{#request.typename}"></s:textfield>
								<font class="font_style">图书名称:</font>
								<s:textfield theme="simple" name="bookname" cssClass="order" readonly="true"
								value="%{#request.bookname}"></s:textfield>
								<br/>
								<font class="font_style">图书ID:</font>
								<s:textfield theme="simple" name="bookISBN" readonly="true" placeholder="图书ID" cssClass="order"
								value="%{#request.isbn}"></s:textfield>
								<font class="font_style">预定数量:</font>
								<s:textfield theme="simple" name="orderamount" cssClass="order" id="ip_amount"  value="1"
								onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"></s:textfield>
								<br/>
								<font id="orderTips"
									style="width:120px; height: 30px;font-size: 15px;margin-left: 34px;color:red;"></font>
								<s:submit theme="simple" cssClass="borrow_button" value="预定" cssStyle="float:right;margin-right:35px;" onclick="orderRecord()"></s:submit>
							</s:form>
						</div>
					</div>
				...
				function orderRecord() {
					document.orderrecordinfo.action = "/library/orderRecord!addRecord.action";

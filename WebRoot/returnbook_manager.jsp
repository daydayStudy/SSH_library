			...
			<div class="row">
				...
				<div class="col c8_table">
					...
					<table id="table" cellspacing="0">
						...
						<s:iterator value="#request.bookPageBean.list" id="list">
							<tr>
								...
								<td class="td"><s:property value="rederid" /></td>
								...
								<td class="td">
									<a id="select" href="rtbook.action?method=select&id=<s:property value="isbn"/>
									&borrowid=<s:property value="borrowid"/>
									&bookname=<s:property value="bookname"/>
									&readid=<s:property value="rederid"/>
									&backdate=<s:property value="backdate"/>
									&amount=<s:property value="amount"/>">归还 </a>
					...
					<div class="div_bottom">
						 ...
						 <s:else>
							 <a href="returnbookManager.action?page=<s:property value="#request.bookPageBean.totalPage"/>" class="a_bottom">尾页</a> 
						 	<a href="returnbookManager.action?page=<s:property value="#request.bookPageBean.currentPage + 1"/>" class="a_bottom">下一页</a> 
						 </s:else>
						 ...
						 <s:else>
						 <a href="returnbookManager.action?page=<s:property value="#request.bookPageBean.currentPage - 1"/>" class="a_bottom">上一页</a> 
						 <a href="returnbookManager.action" class="a_bottom">首页</a>
						 </s:else>
					</div>
				</div>
